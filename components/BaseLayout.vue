    ...
    <footer class="bg-orange-500 text-white">
      <div class="container mx-auto flex flex-col lg:flex-row items-center justify-between py-8">
        ...
        <ul class="flex items-center">
          <li class="mr-8">
            <a href="mailto:ralph19_99@yahoo.com" class="text-white hover:text-gray-400">
          ...
          <li class="mr-8">
            <a href="https://www.youtube.com/channel/UCr71c71lGgvt4Z_dpHgfHUg" target="_blank" class="text-white hover:text-gray-400">
          ...
          <li class="mr-8">
            <a href="https://github.com/Ralph519" target="_blank" class="text-white hover:text-gray-400">
          ...
          <li>
            <a href="https://www.instagram.com/ralphjtoledo/" target="_blank" class="text-white hover:text-gray-400">
